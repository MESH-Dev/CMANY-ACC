...
<?php while ( have_posts() ) : the_post(); ?>
  ...
  <?php if ( tribe_is_new_event_day() && !tribe_is_day() ) : ?>
      ...
      <?php endif; ?>
               ...
               <?php      
                                        $theDate = tribe_get_start_date(null,false);
                                        //echo $theDate; 
                                        if($theDate == 'July 4, 2013'){ ?>
                                        
                                        
                          <?php if(!$isClosed){ ?>
                                        <div style="clear: both;" id="post-<?php the_ID() ?>"<?php post_class('tribe-events-event clearfix') ?> itemscope itemtype="http://schema.org/Event">

                          <?php echo "We are closed today"; ?>
                          <?php $isClosed = true; ?>
                                        </div>
                          <?php } ?>
